...
export const SOCIALS = [
  ...
  },
  {
    idx: "03",
    label: "X",
    href: "https://x.com/sahil_sapariya",
    Icon: Twitter,
  },
  {
    idx: "04",
...
export const PROJECTS = [
  {
    ...
    preview: {
      ...
      alt: "Nexchool marketing site — school management SaaS platform for institutions",
    },
  ...
  },
  {
    ...
    stack: ["Three.js", "Panolens.js", "HTML", "CSS", "JavaScript"],
    ...
    preview: {
      ...
      title: "College360",
      label: "LIVE PROJECT",
      alt: "College360 — 3D virtual campus tour of Dharmsinh Desai University, DUHACKS 2.0 award winner",
    },
    links: {
  ...
  },
  {
    ...
    title: "Conroy",
    year: "2025",
    status: "Shipped · Freelance",
    context:
      "A luxury clothing brand's full e-commerce storefront built on Shopify from scratch — theme development, product catalogue, checkout flow, and third-party app integrations. Freelance delivery for a real client with real revenue expectations.",
    role: "Two-developer team. Both of us worked across the full stack — theme architecture, Liquid templating, custom sections, and app integrations — coordinating directly with the client throughout.",
    decision:
      "Refusing to settle for what Shopify's default aesthetic gives you. The brand is luxury — the storefront had to feel like it, which meant rewriting every spacing decision, typography rule, and interaction from the ground up.",
    stakes:
      "A fashion brand's store is the brand. The first load either earns the sale or loses it. Generic Shopify on a premium label is a contradiction — and the client's customers would notice before they clicked anything.",
    scope: ["Freelance", "Full storefront", "Theme development", "App integrations"],
    stack: ["Shopify", "Liquid", "JavaScript", "CSS"],
    preview: {
      url: "https://conroy.global",
      title: "Conroy",
      label: "LIVE STOREFRONT",
      tagline: "Luxury clothing — built on Shopify from scratch.",
    },
    links: { live: "https://conroy.global" },
  },
];
export const JOURNEY = [
  {
    year: "2017",
    body: "Growing up in a small town, curiosity led me toward technology long before I knew software engineering existed.",
  },
  {
    year: "2019",
    body: "Moved to a metro city for JEE preparation after years of native-language schooling. The experience reshaped my perspective on competition, discipline, and ambition.",
  },
  {
    year: "2021",
    body: "Joined DDU for Information Technology and discovered programming. What started as coursework quickly became a passion for building things.",
  },
  {
    year: "2023",
    body: "Built my first production systems during a startup internship at Trakky, developing their public website and contributing to internal products.",
  },
  {
    year: "2023",
    body: "Led a 4-member team to win Best Open Innovation with College360, a virtual campus exploration platform.",
    highlight: true,
  },
  {
    year: "2024",
    body: "Worked on larger React applications, state management, and collaborative product development through industry internships.",
  },
  {
    year: "2025",
    body: "Joined Jeavio, helping build an AI-assisted writing platform from scratch before transitioning into a full-time engineering role.",
  },
  {
    year: "2025",
    body: "Built Conroy's luxury fashion storefront using Shopify, gaining experience delivering software for real businesses.",
  },
  {
    year: "2026",
    body: "Focused on complete product ownership—architecture, backend systems, deployment pipelines, and production operations.",
  },
  {
    year: "Today",
    body: "Building School ERP and SaaS products while exploring AI-assisted engineering, systems thinking, and scalable software design.",
    active: true,
  },
  {
    year: "Next",
    body: "Working toward building products that scale to thousands of users while deepening expertise in systems engineering and AI-native development.",
  },
];
