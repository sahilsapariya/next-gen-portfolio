...
export const PROJECTS = [
  ...
  },
  {
    ...
    role: "Two-developer team. We both worked across the customisation — Liquid template edits, section modifications, app integrations, and client-facing adjustments throughout the project.",
    decision:
    ...
    scope: ["Freelance", "Theme customisation", "Liquid templates", "App integrations"],
